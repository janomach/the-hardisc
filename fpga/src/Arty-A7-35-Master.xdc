...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { s_clk_i }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { s_clk_i }];

## Switches
set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { s_resetn_i }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
...
#set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { s_resetn_i }]; #IO_L16P_T2_35 Sch=ck_rst
...
#set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { qspi_mosi }]; #IO_L1P_T0_D00_MOSI_14 Sch=qspi_dq[0]
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { qspi_miso }]; #IO_L1N_T0_D01_DIN_14 Sch=qspi_dq[1]
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { qspi_dq[2] }]; #IO_L2P_T0_D02_14 Sch=qspi_dq[2]
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { qspi_dq[3] }]; #IO_L2N_T0_D03_14 Sch=qspi_dq[3]
#set_property -dict { PACKAGE_PIN L16 IOSTANDARD LVCMOS33 } [get_ports { qspi_sck }];

#set_input_delay -max -clock sys_clk_pin 10 [get_ports qspi_miso]
#set_input_delay -min -clock sys_clk_pin 8 [get_ports qspi_miso]
...
## DDR3 MEMORY ####################################################
#set_property -dict { PACKAGE_PIN T8   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[13] }]; #IO_L24N_T3_34
#set_property -dict { PACKAGE_PIN T6   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[12] }]; #IO_L23N_T3_34
#set_property -dict { PACKAGE_PIN U6   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[11] }]; #IO_L22N_T3_34
#set_property -dict { PACKAGE_PIN R6   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[10] }]; #IO_L19P_T3_34
#set_property -dict { PACKAGE_PIN V7   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[9] }]; #IO_L20P_T3_34
#set_property -dict { PACKAGE_PIN R8   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[8] }]; #IO_L24P_T3_34
#set_property -dict { PACKAGE_PIN U7   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[7] }]; #IO_L22P_T3_34
#set_property -dict { PACKAGE_PIN V6   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[6] }]; #IO_L20N_T3_34
#set_property -dict { PACKAGE_PIN R7   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[5] }]; #IO_L23P_T3_34
#set_property -dict { PACKAGE_PIN N6   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[4] }]; #IO_L18N_T2_34
#set_property -dict { PACKAGE_PIN T1   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[3] }]; #IO_L17N_T2_34
#set_property -dict { PACKAGE_PIN N4   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[2] }]; #IO_L16N_T2_34
#set_property -dict { PACKAGE_PIN M6   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[1] }]; #IO_L18P_T2_34
#set_property -dict { PACKAGE_PIN R2   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_addr[0] }]; #IO_L15N_T2_DQS_34

#set_property -dict { PACKAGE_PIN R3   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[15] }]; #IO_L11P_T1_SRCC_34
#set_property -dict { PACKAGE_PIN U3   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[14] }]; #IO_L8N_T1_34
#set_property -dict { PACKAGE_PIN T3   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[13] }]; #IO_L11N_T1_SRCC_34
#set_property -dict { PACKAGE_PIN V1   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[12] }]; #IO_L7N_T1_34
#set_property -dict { PACKAGE_PIN V5   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[11] }]; #IO_L10P_T1_34
#set_property -dict { PACKAGE_PIN U4   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[10] }]; #IO_L8P_T1_34
#set_property -dict { PACKAGE_PIN T5   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[9] }]; #IO_L12P_T1_MRCC_34
#set_property -dict { PACKAGE_PIN V4   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[8] }]; #IO_L10N_T1_34
#set_property -dict { PACKAGE_PIN M2   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[7] }]; #IO_L4N_T0_34
#set_property -dict { PACKAGE_PIN L4   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[6] }]; #IO_L5N_T0_34
#set_property -dict { PACKAGE_PIN M1   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[5] }]; #IO_L1N_T0_34
#set_property -dict { PACKAGE_PIN M3   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[4] }]; #IO_L4P_T0_34
#set_property -dict { PACKAGE_PIN L6   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[3] }]; #IO_L6P_T0_34
#set_property -dict { PACKAGE_PIN K3   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[2] }]; #IO_L2P_T0_34
#set_property -dict { PACKAGE_PIN L3   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[1] }]; #IO_L2N_T0_34
#set_property -dict { PACKAGE_PIN K5   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dq[0] }]; #IO_L5P_T0_34

#set_property -dict { PACKAGE_PIN V2   IOSTANDARD DIFF_SSTL135     } [get_ports { ddr3_sdram_dqs_n[1] }]; #IO_L9N_T1_DQS_34
#set_property -dict { PACKAGE_PIN N1   IOSTANDARD DIFF_SSTL135     } [get_ports { ddr3_sdram_dqs_n[0] }]; #IO_L3N_T0_DQS_34
#set_property -dict { PACKAGE_PIN U2   IOSTANDARD DIFF_SSTL135     } [get_ports { ddr3_sdram_dqs_p[1] }]; #IO_L9P_T1_DQS_34
#set_property -dict { PACKAGE_PIN N2   IOSTANDARD DIFF_SSTL135     } [get_ports { ddr3_sdram_dqs_p[0] }]; #IO_L3P_T0_DQS_34

#set_property -dict { PACKAGE_PIN P5   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_we_n }]; #IO_L13N_T2_MRCC_34
#set_property -dict { PACKAGE_PIN P3   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_ras_n }]; #IO_L14N_T2_SRCC_34
#set_property -dict { PACKAGE_PIN K6   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_reset_n }]; #IO_0_34
#set_property -dict { PACKAGE_PIN M4   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_cas_n }]; #IO_L16P_T2_34
#set_property -dict { PACKAGE_PIN N5   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_cke[0] }]; #IO_L13P_T2_MRCC_34
#set_property -dict { PACKAGE_PIN U1   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dm[1] }]; #IO_L7P_T1_34
#set_property -dict { PACKAGE_PIN L1   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_dm[0] }]; #IO_L1P_T0_34
#set_property -dict { PACKAGE_PIN R5   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_odt[0] }]; #IO_L19N_T3_VREF_34
#set_property -dict { PACKAGE_PIN U8   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_cs_n[0] }]; #IO_25_34

#set_property -dict { PACKAGE_PIN V9   IOSTANDARD DIFF_SSTL135     } [get_ports { ddr3_sdram_ck_n[0] }]; #IO_L21N_T3_DQS_34
#set_property -dict { PACKAGE_PIN U9   IOSTANDARD DIFF_SSTL135     } [get_ports { ddr3_sdram_ck_p[0] }]; #IO_L21P_T3_DQS_34

#set_property -dict { PACKAGE_PIN P2   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_ba[2] }]; #IO_L15P_T2_DQS_34
#set_property -dict { PACKAGE_PIN P4   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_ba[1] }]; #IO_L14P_T2_SRCC_34
#set_property -dict { PACKAGE_PIN R1   IOSTANDARD SSTL135     } [get_ports { ddr3_sdram_ba[0] }]; #IO_L17P_T2_34
## DDR3 MEMORY END ##########################################################
