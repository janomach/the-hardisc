...
1. Follow the guidelines described [here](https://digilent.com/reference/programmable-logic/guides/getting-started-with-vivado).
2. In the Project Manager's general settings set the top module to `platform_artyA7`.
3. The constraint file for the demo is [here](https://github.com/janomach/the-hardisc/tree/main/fpga/src/Arty-A7-35-Master.xdc)
...
You also need to enable [generation](https://digilent.com/reference/learn/programmable-logic/tutorials/arty-programming-guide/start?srsltid=AfmBOoqli3H-yjq7-HWXyhip4-huyRvsZdZZhBtCiFKms9ME7MrWwYPX#creating_program_file) of the `.bin` file.
