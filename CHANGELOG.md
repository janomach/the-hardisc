...
### Fixed
 - BMU is missing in the MA-stage discrepancy check (#34)
...
### Added
 - Support for RISC-V Zcb extension
 - Support for RISC-V Zicond extension

## [1.8.0] - 2026-03-06

### Added
 - Support for RISC-V B extension
 - FPGA platform

### Removed
 - Fast-Multiply option
...
### Fixed
 - Some instruction HINTS were wrongly reported as exceptions
...
[1.8.3]: https://github.com/janomach/the-hardisc/releases/tag/v1.8.3
[1.8.2]: https://github.com/janomach/the-hardisc/releases/tag/v1.8.2
[1.8.1]: https://github.com/janomach/the-hardisc/releases/tag/v1.8.1
[1.8.0]: https://github.com/janomach/the-hardisc/releases/tag/v1.8.0
[1.7.1]: https://github.com/janomach/the-hardisc/releases/tag/v1.7.1
