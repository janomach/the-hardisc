...
4. Change the `BOOTADD` in the [testbench](https://github.com/janomach/the-hardisc/blob/main/ver/tb_mh_wrapper.sv) to `32'h80000000` and `MEMSIZE` to `32'h100000` and recompile the RTL
